...
** Control
   ...
   | f           | counsel-find-file      |                         |
   | g           | keyboard-quit          |                         |
   | h           | evil-window-left       | Starts window hydra     |
   | j           | evil-window-down       | Starts window hydra     |
   | k           | evil-window-up         | Starts window hydra     |
   | l           | evil-window-right      | Starts window hydra     |
   | ;           | -                      | TODO: use               |
   | '           | -                      | TODO: use               |
   |-------------+------------------------+-------------------------|
   | z           | suspend-emacs          |                         |
