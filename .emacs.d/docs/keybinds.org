...
** Control
   ...
   | r           | undo-tree-redo                    | TODO: move to U         |
   | t           | pop-tag-mark                      |                         |
   ...
   | h           | help-map                          | TODO: replace           |
   | j           | electric-newline-and-maybe-indent | TODO: replace           |
   | k           | kill-line                         | TODO: replace           |
   | l           | recenter-top-bottom               | TODO: replace           |
   | ö           | -                                 |                         |
   | ä           | -                                 |                         |
   | '           | -                                 |                         |
   | <           | -                                 |                         |
...
** Prefix: C-w - Window
   ...
   | W     | evil-window-prev             |                        |
   | h     | evil-window-left             | TODO: add c variant    |
   | j     | evil-window-down             | TODO: add c variant    |
   | k     | evil-window-up               | TODO: add c variant    |
   | l     | evil-window-right            | TODO: add c variant    |
** Overwritten
