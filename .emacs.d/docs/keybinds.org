...
* Undo-tree
  | Key | Function                         | Comment               |
  |-----+----------------------------------+-----------------------|
  | j   | my-visualize-redo                | preserves time stamps |
  | k   | my-visualize-undo                | preserves time stamps |
  | h   | my-visualize-switch-branch-left  | preserves time stamps |
  | l   | my-visualize-switch-branch-right | preserves time stamps |
